const dataDoctor = [
  {
    id: "1",
    name: "DR. Felix Trần",
    position: " Giám đốc chuyên môn phẫu thuật Bệnh viện thẩm mỹ Đông Á",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-felix-huynh.png",
  ...
  },
  {
    ...
    name: "BS Kevin Phạm",
    position:
      " Bác sĩ chuyên khoa Phẫu thuật tạo hình - Thẩm mỹ Bệnh viện thẩm mỹ Đông Á",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-kevin-pham.png",
    category: "Phẫu thuật thẩm mỹ",
    showHome: "true",
    imageRegion: "none",
    description:
  ...
  {
    id: "3",
    name: "BS Henry Nguyen",
    position:
      " Bác sĩ chuyên khoa Phẫu thuật tạo hình - Thẩm mỹ Bệnh viện thẩm mỹ Đông Á",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-henry-nguyen.png",
    showHome: "true",
    imageRegion: "none",
    description:
      "<ul>\n<li>Bác sĩ chuyên khoa Phẫu thuật tạo hình &#8211; Thẩm mỹ Bệnh viện thẩm mỹ Đông Á</li>\n<li>Thành viên Hiệp hội thẩm mỹ tái tạo gương mặt Hàn Quốc KAFPRS</li>\n<li>Thành viên Hiệp hội thẩm mỹ Hàn Quốc KCCS</li>\n<li>Ủy viên hội nghiên cứu chỉnh hình mũi &#8211; Hiệp hội chỉnh hình Hàn Quốc</li>\n</ul>\n",
  ...
  },
  {
    ...
    position:
      " Bác sĩ chuyên khoa Phẫu thuật tạo hình - Thẩm mỹ Bệnh viện thẩm mỹ Đông Á",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-raymond-dan.png",
    category: "Phẫu thuật thẩm mỹ",
    showHome: "true",
    imageRegion: "none",
    description:
  ...
  {
    id: "5",
    name: "BS Robert Nguyen",
    position:
      " Bác sĩ chuyên khoa Phẫu thuật Tạo hình vóc dáng - Bệnh viện Thẩm mỹ Đông Á",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-robert-nguyen.png",
    category: "Phẫu thuật thẩm mỹ",
    showHome: "true",
    imageRegion: "none",
    description:
  ...
  {
    id: "6",
    name: "TS.BS David Lee",
    position:
      " Bác sĩ Phẫu thuật Tạo hình Thẩm mỹ cấp cao - Trưởng khoa Phẫu thuật Thẩm mỹ tại Bệnh viện Thẩm mỹ Đông Á (Hà Nội)",
    image:
      "https://benhvienthammydonga.vn/wp-content/uploads/2023/02/bs-david-lee.png",
    category: "Phẫu thuật thẩm mỹ",
    showHome: "true",
    imageRegion: "none",
    description:
  ...
  },
  {
    ...
    imageRegion: "none",
    description:
      "<ul>\n<li>BS Điều trị nám &#8211; tàn nhang công nghệ cao</li>\n<li>Thạc sĩ – Bác sĩ chuyên ngành da liễu cấp cao</li>\n</ul>\n",
    dataModal:
      '<ul>\n<li class="popupdoctor_da_1_0_0__name">\n        <span class="popupdoctor_da_1_0_0__icon popupdoctor_da_1_0_0__icon--1"></span><br />\n        <span class="popupdoctor_da_1_0_0__titleName">chức vụ</span>\n    </li>\n<li>BS Điều trị nám &#8211; tàn nhang công nghệ cao</li>\n<li>Thạc sĩ – Bác sĩ chuyên ngành da liễu cấp cao</li>\n<li class="popupdoctor_da_1_0_0__name">\n        <span class="popupdoctor_da_1_0_0__icon popupdoctor_da_1_0_0__icon--2"></span><br />\n        <span class="popupdoctor_da_1_0_0__titleName">quá trình học tập và công tác</span>\n    </li>\n<li>Tốt nghiệp trường đại học Y dược HCM</li>\n<li class="popupdoctor_da_1_0_0__name">\n        <span class="popupdoctor_da_1_0_0__icon popupdoctor_da_1_0_0__icon--3"></span><br />\n        <span class="popupdoctor_da_1_0_0__titleName">kinh nghiệm làm việc</span>\n    </li>\n<li>Có 20 năm kinh nghiệm trong lĩnh vực điều trị da</li>\n</ul>\n',
  },
];
...
const showModalRegister = () => {
  let html = `
    <div class="modal doctor_da_1_0_0__register" id="modal-register" style="display: flex">
      <div class="modal-bg modal-bg--1"></div>
      <div class="modal-box animate-pop doctor_da_1_0_0__boxModal">
          <div class="doctor_da_1_0_0__form">
              <span>ĐẶT LỊCH TƯ VẤN CÙNG BÁC SĨ</span>
              <article>
                  <div class="doctor_da_1_0_0__formRegist ">
                  ...
                  <div class="doctor_da_1_0_0__registModal" onclick="ants_send_contact(this)">
                          <div class="doctor_da_1_0_0__coatingModal">
                              <p>Gửi thông tin</p>
                          </div>
                          <div class="doctor_da_1_0_0__iconRegModal">
